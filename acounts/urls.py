...
urlpatterns = [
    ...
    path(
        "resest_password_validate/<uidb64>/<token>/",
        views.resest_password_validate,
        name="resest_password_validate",
    ),
    ...
    path(
        "or_pr_detail/<int:order_product_id>/", views.or_pr_detail, name="or_pr_detail"
    ),
