...
class Acount(AbstractBaseUser):
    ...
    Referal_code = models.CharField(
        max_length=6, unique=True, default=generate_unique_referral_code
    )
...
class UserProfile(models.Model):
    ...
    profile_picture = models.ImageField(
        blank=True, upload_to="userprofile/", default="/static/images/logo vg.jpg"
    )
...
class Referal_code(models.Model):
    ...
    referrer_user = models.ForeignKey(
        Acount, on_delete=models.CASCADE, related_name="referral_code_given"
    )
