...
urlpatterns = [
    ...
    path(
        "delete_customer/<int:user_id>/", views.delete_customer, name="delete_customer"
    ),
    ...
    path(
        "delete_products/<int:product_id>/",
    ...
    path(
        "delete_category/<int:cat_id>/", views.delete_category, name="delete_category"
    ),
    path(
        "order_details_admin/<int:order_id>/",
        views.order_details_admin,
        name="order_details_admin",
    ),
    ...
    path(
        "delete_coupons/<int:coupon_id>/", views.delete_coupons, name="delete_coupons"
    ),
    path("profiles/<int:customer_id>/", views.profiles, name="profiles"),
    path("ad_refer", views.ad_refer, name="ad_refer"),
    path(
        "minimum_purchase_offers",
        views.minimum_purchase_offers,
        name="minimum_purchase_offers",
    ),
    ...
    path(
        "edit_minimum_purchaseoffer/<int:offer_id>/",
        views.edit_minimum_purchase_offer,
        name="edit_minimum_purchase_offer",
    ),
    path(
        "add_minimum_purchase_offer",
        views.add_minimum_purchase_offer,
        name="add_minimum_purchase_offer",
    ),
    path(
        "delete_minimum_purchase_offer/<int:offer_id>/",
        views.delete_minimum_purchase_offer,
        name="delete_minimum_purchase_offer",
    ),
